...
def get_loss(model, x_0, t, c, device):
...
if __name__ == "__main__":
    ...
    dataloader = load_transformed_dataset(batch_size=BATCH_SIZE, dataset_name="datasets-2")
    ...
    for epoch in range(epochs):
        for batch_idx, (batch, labels) in enumerate(dataloader):
            ...
            loss = get_loss(model, batch, t, labels, device)
    ...
    torch.save(model.state_dict(), f"./ddpm_cond_epochs_{epochs}.pth")
